...
namespace PayitDealerGlobalPayit.DAL
{
    ...
    public partial class PayitGlobalDealersDBEntities : DbContext
    {
        ...
        public virtual int GetPinStocks(Nullable<int> serviceId)
        {
            var serviceIdParameter = serviceId.HasValue ?
                new ObjectParameter("serviceId", serviceId) :
                new ObjectParameter("serviceId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetPinStocks", serviceIdParameter);
        }
    
        public virtual ObjectResult<Sp_AccountLevelReport_Result> Sp_AccountLevelReport(Nullable<int> accountid, Nullable<int> dealerid, Nullable<int> agentid, Nullable<int> serviceId, Nullable<int> deviceid, Nullable<decimal> amount, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> accountUserId)
        {
            var accountidParameter = accountid.HasValue ?
                new ObjectParameter("Accountid", accountid) :
                new ObjectParameter("Accountid", typeof(int));
            ...
            var accountUserIdParameter = accountUserId.HasValue ?
                new ObjectParameter("AccountUserId", accountUserId) :
                new ObjectParameter("AccountUserId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_AccountLevelReport_Result>("Sp_AccountLevelReport", accountidParameter, dealeridParameter, agentidParameter, serviceIdParameter, deviceidParameter, amountParameter, startDateParameter, endDateParameter, accountUserIdParameter);
        }
    
        public virtual ObjectResult<Sp_AgentLevelReport_Result> Sp_AgentLevelReport(Nullable<int> accountid, Nullable<int> dealerid, Nullable<int> agentid, Nullable<int> serviceId, Nullable<int> deviceid, Nullable<decimal> amount, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> accountUserId)
        {
            var accountidParameter = accountid.HasValue ?
                new ObjectParameter("Accountid", accountid) :
                new ObjectParameter("Accountid", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_AgentLevelReport_Result>("Sp_AgentLevelReport", accountidParameter, dealeridParameter, agentidParameter, serviceIdParameter, deviceidParameter, amountParameter, startDateParameter, endDateParameter, accountUserIdParameter);
        }
    
        public virtual ObjectResult<Sp_DealerLevelReport_Result> Sp_DealerLevelReport(Nullable<int> accountId, Nullable<int> dealerid, Nullable<int> agentid, Nullable<int> serviceId, Nullable<int> deviceid, Nullable<decimal> amount, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> accountUserId)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("AccountId", accountId) :
                new ObjectParameter("AccountId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_DealerLevelReport_Result>("Sp_DealerLevelReport", accountIdParameter, dealeridParameter, agentidParameter, serviceIdParameter, deviceidParameter, amountParameter, startDateParameter, endDateParameter, accountUserIdParameter);
        }
    
        public virtual ObjectResult<Sp_ServiceLevelReport_Result> Sp_ServiceLevelReport(Nullable<int> accountId, Nullable<int> dealerid, Nullable<int> agentid, Nullable<int> serviceId, Nullable<int> deviceid, Nullable<decimal> amount, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> accountUserId)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("AccountId", accountId) :
                new ObjectParameter("AccountId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_ServiceLevelReport_Result>("Sp_ServiceLevelReport", accountIdParameter, dealeridParameter, agentidParameter, serviceIdParameter, deviceidParameter, amountParameter, startDateParameter, endDateParameter, accountUserIdParameter);
        }
    
        public virtual ObjectResult<Sp_Transactions_Result> Sp_Transactions(Nullable<int> accountId, Nullable<int> dealerid, Nullable<int> agentid, Nullable<int> serviceId, Nullable<int> deviceid, Nullable<decimal> amount, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> accountUserId)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("AccountId", accountId) :
                new ObjectParameter("AccountId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_Transactions_Result>("Sp_Transactions", accountIdParameter, dealeridParameter, agentidParameter, serviceIdParameter, deviceidParameter, amountParameter, startDateParameter, endDateParameter, accountUserIdParameter);
        }
    
        public virtual int Sp_Transactions_Summary(Nullable<int> accountId, Nullable<int> dealerid, Nullable<int> agentid, Nullable<int> serviceId, Nullable<int> deviceid, Nullable<decimal> amount, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> accountUserId)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("AccountId", accountId) :
                new ObjectParameter("AccountId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_Transactions_Summary", accountIdParameter, dealeridParameter, agentidParameter, serviceIdParameter, deviceidParameter, amountParameter, startDateParameter, endDateParameter, accountUserIdParameter);
        }
    
        public virtual ObjectResult<Usp_DealerTransactions_Summary_Result> Usp_DealerTransactions_Summary(Nullable<int> accountId, Nullable<int> dealerid, Nullable<int> agentid, Nullable<int> serviceId, Nullable<int> deviceid, Nullable<decimal> amount, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> accountUserId)
        {
            var accountIdParameter = accountId.HasValue ?
                new ObjectParameter("AccountId", accountId) :
                new ObjectParameter("AccountId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Usp_DealerTransactions_Summary_Result>("Usp_DealerTransactions_Summary", accountIdParameter, dealeridParameter, agentidParameter, serviceIdParameter, deviceidParameter, amountParameter, startDateParameter, endDateParameter, accountUserIdParameter);
        }
    }
}
