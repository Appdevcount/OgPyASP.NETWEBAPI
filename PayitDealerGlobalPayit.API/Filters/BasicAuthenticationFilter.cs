...
namespace PayitDealerGlobalPayit.API
{
    ...
    public class BasicAuthenticationFilter : AuthorizationFilterAttribute
    {
        ...
        //public BasicAuthenticationFilter(IGlobalPayitService globalPayitService)
        //{
        //    this._globalPayitService = globalPayitService;
        ...
        protected virtual bool OnAuthorizeUser(string username, string password, HttpActionContext actionContext)
        {
           ...
           // Controllers.GlobalApps glo = new Controllers.GlobalApps


           // Controllers.GlobalApps.username = username;
            //Controllers.GlobalApps.password = password;

           // return GlobalPayit.API.Controllers.GlobalApps.AuthenticateCredentials();
            return true;
           /* if (username.Equals("payit") && password.Equals("payit"))
            {
